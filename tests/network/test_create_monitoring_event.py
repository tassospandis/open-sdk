...
from tests.network.conftest import camara_payload_input_data, instantiate_network_client


def test_camara_tf_3gpp_event(
    network_client: NetworkManagementInterface,
